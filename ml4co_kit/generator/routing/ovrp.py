...
class OVRP_TYPE(str, Enum):
    """Define the OVRP types as an enumeration."""
    UNIFORM = "uniform" # Uniform coords
    GAUSSIAN = "gaussian" # Gaussian coords


class OVRPGenerator(CVRPGenerator):
    """Generator for Open Vehicle Routing Problem instances."""

    def __init__(
        self,
        distribution_type: OVRP_TYPE = OVRP_TYPE.UNIFORM,
        ...
        super(OVRPGenerator, self).__init__(
        ...
        # Reset Attributes for OVRP
        self.task_type = TASK_TYPE.OVRP
        self.distribution_type = distribution_type

        # Generation Function Dictionary
        self.generate_func_dict = {
            OVRP_TYPE.UNIFORM: self._generate_uniform,
            OVRP_TYPE.GAUSSIAN: self._generate_gaussian,
        }

    def _generate_uniform(self) -> OVRPTask:
        ...
        # Create OVRP Instance from Data
        task_data = OVRPTask(
    ...
    def _generate_gaussian(self) -> OVRPTask:
        # Generate demands and capacity
        demands, capacity = self._generate_demands_and_capacity()
