r"""
Generator for CVRPBTW instances.
"""
...
class CVRPBTWGenerator(CVRPGenerator):
    """Generator for CVRPBTW instances."""
    ...
    def __init__(
        ...
        # special args for B-TW
        bh_ratio: float = 0.2,
        max_time: float = 4.6,
    ):
        # Super Initialization
        super(CVRPBTWGenerator, self).__init__(
            cvrp_open=cvrp_open,
        ...
        # Set Task Type
        self.task_type = TASK_TYPE.CVRPBTW

        # Extra Attributes
        self.bh_ratio = bh_ratio
        self.max_time = max_time

    def _generate_uniform(self) -> CVRPBTWTask:
        ...
        # Create CVRPBTW Instance from Data
        task_data = CVRPBTWTask(
    ...
    def _generate_gaussian(self) -> CVRPBTWTask:
        # Generate demands and capacity
        demands, capacity = self._generate_demands_and_capacity()
