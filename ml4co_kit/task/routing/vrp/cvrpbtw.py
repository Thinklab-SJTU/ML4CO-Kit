...
CVRPBTW can be seen as a combination of CVRPB and CVRPTW.
"""
...
class CVRPBTWTask(CVRPTask):
    def __init__(
        ...
        super(CVRPBTWTask, self).__init__(
            cvrp_open=cvrp_open,
    ...
    def check_constraints(self, sol: np.ndarray) -> bool:
        ...
        # 4. if the route time windows are satisfied
        for split_idx in range(len(split_tours)):   
            ...
            # 4. Route time windows are satisfied
    ...
    def render(
        ...
        pass
        # TODO: Implement the render method for CVRPBTW