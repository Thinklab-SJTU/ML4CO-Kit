import numpy as np
from ml4co_kit.algorithm.mis.c_arw import c_mis_three_improve


def mis_3improve_local_search(
    ...
    c_mis_three_improve(nodes_num, xadj, adjncy, initial_sol, output)
    return output
