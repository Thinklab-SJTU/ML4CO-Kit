...
#ifndef _DIRECT_THREE_LS_H_
#define _DIRECT_THREE_LS_H_
...
class three_improve {
    ...
    public:
        ...
        /**
         * Run the the three-improvement algorithm proposed by Andrade et al.
         *
         * @param G Graph representation.
    ...
    private:
         ...
         * @param G Graph representation.
         */
        void update_candidates(NodeID node_x, NodeID node_y, graph_access & G);
         ...
         * @param G Graph representation.
         */
        void build_onetight(NodeID node_x, NodeID node_y, NodeID u, graph_access & G);
