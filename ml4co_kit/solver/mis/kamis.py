r"""
Gurobi Solver for solving MVC.

KaMIS Solver is a powerful tool designed for solving the MIS problem. 
KaMIS employs a combination of greedy algorithms, local search techniques, 
and meta-heuristics like Simulated Annealing and Genetic Algorithms to
explore the solution space. These methods are designed to quickly converge 
to good solutions, even for large-scale graphs where exact methods would be too slow.

We follow https://github.com/KarlsruheMIS/KaMIS and https://github.com/MaxiBoether/mis-benchmark-framework
for the implementation of KaMIS Solver. 
"""
