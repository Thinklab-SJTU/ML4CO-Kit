...
from .isco_base import (
    PASMHSampler, LinearTemperatureScheduler, 
    EnergyFunction, metropolis_hastings_accept
)


class MISEnergyFunction(EnergyFunction):
    def __init__(
        self, 
        ...
        super(MISEnergyFunction, self).__init__()
...
def mis_isco(
    ...
    # Energy Function
    energy_func = MISEnergyFunction(adj_matrix, nodes_weight, isco_beta)
