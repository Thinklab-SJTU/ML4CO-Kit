...
# @author Yibo Lin
# @date   Mar 2019
# @brief  A python implementation of placement drawer as an 
# alternative when cairo C/C++ API is not available.
...
class PlaceDrawer(object):
    """
    @brief A python implementation of placement drawer as an alternative 
    when cairo C/C++ API is not available. 
    """
    @staticmethod
    def forward(pos,
                node_size_x,
