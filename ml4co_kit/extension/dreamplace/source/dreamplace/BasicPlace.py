...
class BasicPlace(nn.Module):
    ...
    def build_draw_placement(self, params, placedb):
        ...
        try:
            ...
            if params.plot_flag:
                raise ImportError("Plotting requires BUILD_DRAW_PLACE=ON") from e
            return None
    ...
    def plot(self, params, placedb, iteration, pos):
        ...
        if self.op_collections.draw_place_op is None:
            raise RuntimeError("Plotting requires BUILD_DRAW_PLACE=ON")
