...
from ml4co_kit import SATPGenerator, SAT_TYPE
from tests.generator_test.base import GenTesterBase


class SATPGenTester(GenTesterBase):
    def __init__(self):
        super(SATPGenTester, self).__init__(
            test_gen_class=SATPGenerator,
            test_args_list=[
                # 3-SAT
                {
