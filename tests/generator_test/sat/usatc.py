...
from ml4co_kit import USATCGenerator, SAT_TYPE
from tests.generator_test.base import GenTesterBase


class USATCGenTester(GenTesterBase):
    def __init__(self):
        super(USATCGenTester, self).__init__(
            test_gen_class=USATCGenerator,
            test_args_list=[
                # 3-SAT
                {
