...
class CVRPWrapperTester(WrapperTesterBase):
    def __init__(self):
        super(CVRPWrapperTester, self).__init__(
            ...
            txt_files_list=[
                pathlib.Path("test_dataset/routing/vrp/cvrp/wrapper/cvrp50_uniform_16ins.txt"),
                pathlib.Path("test_dataset/routing/vrp/cvrp/wrapper/cvrp500_uniform_4ins.txt"),
            ],
        )
    ...
    def _test_other_rw_methods(self):
        ...
        wrapper.from_vrplib_folder(
            vrp_folder_path=pathlib.Path("test_dataset/routing/vrp/cvrp/vrplib/problem_1"),
            sol_folder_path=pathlib.Path("test_dataset/routing/vrp/cvrp/vrplib/solution_1"),
            ref=True,
            overwrite=True,
            normalize=True
        )
        ...
        wrapper.from_vrplib_folder(
            vrp_folder_path=pathlib.Path("test_dataset/routing/vrp/cvrp/vrplib/problem_2"),
            sol_folder_path=pathlib.Path("test_dataset/routing/vrp/cvrp/vrplib/solution_2"),
            ref=True,
            overwrite=True,
            normalize=True
        )
        ...
        txt_path = pathlib.Path("test_dataset/routing/vrp/cvrp/wrapper/cvrp50_uniform_16ins.txt")
        pkl_path = pathlib.Path("test_dataset/routing/vrp/cvrp/wrapper/cvrp50_uniform_16ins.pkl")
