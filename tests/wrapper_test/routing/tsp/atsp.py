...
class ATSPWrapperTester(WrapperTesterBase):
    def __init__(self):
        super(ATSPWrapperTester, self).__init__(
            ...
            txt_files_list=[
                pathlib.Path("test_dataset/routing/tsp/atsp/wrapper/atsp50_uniform_16ins.txt"),
                pathlib.Path("test_dataset/routing/tsp/atsp/wrapper/atsp500_uniform_4ins.txt"),
            ],
        )
    ...
    def _test_other_rw_methods(self):
        ...
        wrapper.from_tsplib_folder(
            atsp_folder_path=pathlib.Path("test_dataset/routing/tsp/atsp/tsplib/problem"),
            tour_folder_path=pathlib.Path("test_dataset/routing/tsp/atsp/tsplib/solution"),
            ref=True,
            overwrite=True,
            normalize=True
        )
        ...
        txt_path = pathlib.Path("test_dataset/routing/tsp/atsp/wrapper/atsp50_uniform_16ins.txt")
        pkl_path = pathlib.Path("test_dataset/routing/tsp/atsp/wrapper/atsp50_uniform_16ins.pkl")
