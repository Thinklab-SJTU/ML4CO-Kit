...
class TSPWrapperTester(WrapperTesterBase):
    def __init__(self):
        super(TSPWrapperTester, self).__init__(
            ...
            txt_files_list=[
                pathlib.Path("test_dataset/routing/tsp/tsp/wrapper/tsp50_uniform_16ins.txt"),
                pathlib.Path("test_dataset/routing/tsp/tsp/wrapper/tsp500_uniform_4ins.txt"),
            ],
        )
    ...
    def _test_other_rw_methods(self):
        ...
        wrapper.from_tsplib_folder(
            tsp_folder_path=pathlib.Path("test_dataset/routing/tsp/tsp/tsplib/problem"),
            tour_folder_path=pathlib.Path("test_dataset/routing/tsp/tsp/tsplib/solution"),
            ref=True,
            overwrite=True,
            normalize=True
        )
        ...
        wrapper = TSPWrapper()
        txt_path = pathlib.Path("test_dataset/routing/tsp/tsp/wrapper/tsp50_uniform_16ins.txt")
        ...
        wrapper.from_task_pickle_folder(
            task_class=TSPTask, folder_path=pathlib.Path("test_dataset/routing/tsp/tsp/task")
        )
